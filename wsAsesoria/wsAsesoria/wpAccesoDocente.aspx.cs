...
{
    public partial class wpAccesoDocente : System.Web.UI.Page
    {
        ...
        private async Task cargarDatosApi()
        {
            try
            {
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    string apiURL = "https://localhost:44355/full/usuario/spvalidaraccesodocente";
                    ...
                    if (respuesta.IsSuccessStatusCode)
                    {
                        ...
                        if (ban == "1")
                        {
                            Session["docNombre"] = ds.Tables[0].Rows[0][1].ToString();
                            Session["docUsuario"] = ds.Tables[0].Rows[0][2].ToString();
                            Response.Write("<script language = 'javascript'>" +
                                "alert('Bienvenido(a): " + Session["docNombre"] + "');" +
                                "</script>");
