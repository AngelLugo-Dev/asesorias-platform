...
{
    public partial class wpRegistroEstudiante : System.Web.UI.Page
    {
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    String data = @"{
                                  ...
                                  "\"semestre\":\"" + TextBox5.Text + "\"," +
                                  "\"carrera\":\"" + TextBox6.Text + "\"," +
                                  "\"usuario\":\"" + TextBox7.Text + "\"," +
                                  "\"contrasenia\":\"" + TextBox8.Text + "\"" +
                                  "}";
                    ...
                    string apiUrl = "https://localhost:44355/full/usuario/spinsestudiante";
                    // ----------------------------------------------
