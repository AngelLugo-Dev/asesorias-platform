<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="wpRegistroEstudiante.aspx.cs" Inherits="wsAsesoria.wpRegistroEstudiante" %>
                         ...
                         <tr>
                                ...
                                <td width="70%" class="bg-light">
                          	        <div class="input-group mb-1">
                                        ...
                                        <asp:TextBox ID="TextBox6" runat="server" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon4"></asp:TextBox>
                                    </div>
                         ...
                         <tr>
                                ...
                                <td width="70%" class="bg-light">
                          	        <div class="input-group mb-1">
                                        ...
                                        <asp:TextBox ID="TextBox7" runat="server" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon4"></asp:TextBox>
                                    </div>
                        ...
                        <tr>
                                ...
                                <td width="70%" class="bg-light">
                          	        <div class="input-group mb-1">
                                        ...
                                        <asp:TextBox ID="TextBox8" runat="server" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="basic-addon5"></asp:TextBox>
                                    </div>
